...
import (
	...
	viewv1 "github.com/wafuwafu13/learn-kubebuilder/api/v1"
)
...
// +kubebuilder:webhook:path=/mutate-view-wafuwafu13-github-io-v1-markdownview,mutating=true,failurePolicy=fail,sideEffects=None,groups=view.wafuwafu13.github.io,resources=markdownviews,verbs=create;update,versions=v1,name=mmarkdownview-v1.kb.io,admissionReviewVersions=v1
...
func (d *MarkdownViewCustomDefaulter) Default(_ context.Context, obj runtime.Object) error {
...
// +kubebuilder:webhook:path=/validate-view-wafuwafu13-github-io-v1-markdownview,mutating=false,failurePolicy=fail,sideEffects=None,groups=view.wafuwafu13.github.io,resources=markdownviews,verbs=create;update,versions=v1,name=vmarkdownview-v1.kb.io,admissionReviewVersions=v1
...
func (v *MarkdownViewCustomValidator) ValidateCreate(_ context.Context, obj runtime.Object) (admission.Warnings, error) {
	markdownview, ok := obj.(*viewv1.MarkdownView)
	if !ok {
...
func (v *MarkdownViewCustomValidator) ValidateUpdate(_ context.Context, oldObj, newObj runtime.Object) (admission.Warnings, error) {
